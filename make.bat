...
::move mateFishL%v%_%datestamp%_popcnt Matefinder_binaries
::move mateFishL%v%_%datestamp%_bmi2 Matefinder_binaries
::move mateFishL%v%_%datestamp%_base Matefinder_binaries
::move mateFishL%v%_%datestamp%_v8 Matefinder_binaries
::move mateFishX%v%_%datestamp%_popcnt Matefinder_binaries
::move mateFishX%v%_%datestamp%_bmi2 Matefinder_binaries
::move mateFishX%v%_%datestamp%_base Matefinder_binaries
